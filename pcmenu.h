...
#define M_ASISTITLE     0x80            /* left adjust title */
...
typedef struct
{
        ...
        char            m_curptr;       /* marker for current item      */
        char            m_markptr;      /* marker for a marked item     */
        ...
        int             m_selcnt;       /* number of entries to select  */
        mitem_t         *m_items;       /* pointer to items             */
        mitem_t         *m_curi;        /* last selected item           */
} menu_t;
